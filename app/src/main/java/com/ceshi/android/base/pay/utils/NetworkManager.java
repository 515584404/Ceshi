...
public class NetworkManager{
    ...
    public String SendAndWaitResponse(String strReqData, String strUrl)
    {
        ...
        try
        {
            ...
            strResponse = com.ceshi.android.base.pay.utils.BaseHelper.convertStreamToString(content);
            com.ceshi.android.base.pay.utils.BaseHelper.log(TAG, "response " + strResponse);
        } catch (IOException e)
        {
            e.printStackTrace();
        } finally

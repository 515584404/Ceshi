...
public class SharePrefUtil {
    ...
    public static String sp_jessonid="jessonid";
    public static String sp_uuid="uuid";
    public static String sp_ifonline="ifOnline";
    public static String sp_userhead="userhead";
    public static String sp_foundpic="foundpic";
    public static String sp_youqu_citycode="youquCode";
    public static String sp_youqu_cityName="youquName";
    public static String sp_mainpic="mainpic";
    public static String sp_show_guide="ifShowGuide";
    ...
    public static void saveString(Context context, String key, String value) {
        if (sp == null)
            Logger.d("SharePrefUtil","--->new a SharedPreferences");
            sp = context.getSharedPreferences(SP_NAME, 0);

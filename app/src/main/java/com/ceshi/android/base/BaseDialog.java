...
public class BaseDialog extends Dialog implements View.OnClickListener{
    ...
    private LinearLayout mLayoutTop;// 头部根布局 --> top=title+content
    private LinearLayout mLayoutTitle;// 标题根布局 --> title=htvtitle+line
    ...
    public BaseDialog(Context context,boolean b){
    ...
    public BaseDialog(Context context) {
        super(context, R.style.Theme_Light_FullScreenDialogAct);
        this.mContext=context;
        setContentView(R.layout.base_common_dialog_general);
        initViews();
        initEvents();
    }
    /************************** 初始化 ****************************/
    ...
    /**
     * 设置dialog在屏幕外点击是否会消失
     * @param a 点击空白区域是否会消失,true 会
     * @param b 点击返回按钮是否会消失,true 会
     * 默认的都会消失
     */
    public void setDialogCancelable(boolean a,boolean b){
